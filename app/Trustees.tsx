...
export default function Trustees({
    ...
    return(
        <div className={`${quicksand.className} group relative bg-white rounded-xl shadow-2xl shadow-neutral-600 overflow-hidden transition-transform duration-300 border-3 border-amber-100 hover:scale-105 hover:shadow-2xl hover:shadow-black`}>
